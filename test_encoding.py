...
with open(f'res/{prefix}_same.md', 'w') as same, \
        open(f'res/{prefix}_different.md', 'w') as different, \
        open(f'res/{prefix}_all.csv', 'w') as all_succeeded, \
        open(f'res/{prefix}_skipped.csv', 'w') as all_skipped, \
        open(f'res/{prefix}_exceptions.txt', 'w') as all_exceptions:
